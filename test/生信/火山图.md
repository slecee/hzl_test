...
data_bind$des[(data_bind$fdr < 0.05) & (data_bind$VIP > 1)& (data_bind$logfc < 0.5)]<-'down-regulated'
data_bind$des[(data_bind$fdr < 0.05) & (data_bind$VIP > 1)& (data_bind$logfc > 2)]<-'up-regulated'
